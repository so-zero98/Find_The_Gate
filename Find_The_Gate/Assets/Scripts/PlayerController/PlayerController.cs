...
public class PlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Space) && GameManager.instance.whatState == GameManager.GameState.game)
        {
            playerColor.material.color = new Color(255f / 255f, 235f / 255f, 0);
            isSet = true;
        }
        else if(Input.GetKeyUp(KeyCode.Space) && GameManager.instance.whatState == GameManager.GameState.game)
        {
            playerColor.material.color = new Color(128f / 255f, 128f / 255f, 128f / 255f);
            isSet = false;
        }
    ...
    void FixedUpdate()
    {
        ...
        if (GameManager.instance.whatState == GameManager.GameState.game && isSet == true)
